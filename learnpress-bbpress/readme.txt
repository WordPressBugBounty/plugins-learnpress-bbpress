...
**LearnPress bbPress** is an add-on for **<a href="https://wordpress.org/plugins/learnpress/" title="WordPress LMS">WordPress LMS</a>** - LearnPress, which brings forum to your course. Now, teacher can interact with students and students in a course can discuss with each other about the course. LearnPress bbPress simply empower course with feartures of forum.
...
**From WordPress.org**
1. Search, select and download LearnPress bbPress.
...
= 4.0.7 (2025-05-09) =
~ Show forum on single course Modern layout and Gutenberg.
...
= 4.0.3 =
+ Fixed: error get id of course wrong when query.
...
= 3.0.5 =
+ Remove function set bbpress roles is lp_teacher make can't access 'frontend editor' plugin

= 3.0.4 =
+ Fixed issue not restrict forum access for child forum.
...
= 0.9.2 =
+ Fixed bug in restrict content for user guest
+ Updated link respective course for forum
